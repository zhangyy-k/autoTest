...
public class ExcelUtil {
    static protected final LoggerControler log = LoggerControler.getLogger(ExcelUtil.class);

    static private Workbook workbook = null;
...
//        判断文件是否存在
     ...
     * @param object
     */
    public static void writeToExcel(String filePath, String sheetName, Object object) throws IOException {
        //创建workbook
        File file = new File(filePath);
        ...
        try {
            if(fileExtensionName.equals(".xlsx"))
                ...
                workbookTemp = new HSSFWorkbook(inputStream);
     ...
     * @param object    webSys.teacher.object
     */
    public static Object[][] readFromExcel(String filePath, String sheetName, Object object) {
        //创建workbook
        File file = new File(filePath);
        try {
            String fileName = file.getName();
        ...
        Object[] objects1 = result.toArray();
        for(int i =0;i <objects1.length;i++){
            Object[] temp = {objects1[i]};
            objects[i] = temp;
        }
        return objects;
    }
